...
class PhoneNumberTest < Minitest::Test
  ...
  def test_that_area_code_is_all_zeros_with_invalid_number
    number = PhoneNumber.new("9876543")
    assert_equal "000", number.area_code
  end
  ...
  def test_prints_all_zeros_with_invalid_number
